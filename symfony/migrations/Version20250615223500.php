 ...
 */
final class Version20250615223500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, score_total INT DEFAULT 0 NOT NULL, creation_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, last_co DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, is_verified TINYINT(1) NOT NULL, roles JSON NOT NULL, last_try_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_9B80EC645126AC48 (mail), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
