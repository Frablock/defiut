 ...
 */
final class Version20250618130424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Defi (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, cle VARCHAR(255) NOT NULL, points_recompense INT NOT NULL, categorie VARCHAR(255) NOT NULL, difficulte INT DEFAULT NULL, user_id INT NOT NULL, defi_valid_utilisateur_id INT NOT NULL, UNIQUE INDEX UNIQ_7CE70C6041401D17 (cle), INDEX IDX_7CE70C60A76ED395 (user_id), INDEX IDX_7CE70C60DFABEAE4 (defi_valid_utilisateur_id), UNIQUE INDEX id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE Defi_Indice (ordre INT NOT NULL, defi_id INT NOT NULL, indice_id INT NOT NULL, INDEX IDX_8187619573F00F27 (defi_id), INDEX IDX_81876195C8C0B132 (indice_id), UNIQUE INDEX un_defi_indice_ordre (defi_id, ordre), PRIMARY KEY(defi_id, indice_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
