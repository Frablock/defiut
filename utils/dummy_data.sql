...
VALUES (
        1,
        'Le commit perdu',
        'Tu travailles sur un devoir ultra important. Après une longue nuit de code, tu commit une fonctionnalité essentielle… mais dans un moment de fatigue, tu tapes une mauvaise commande et ton commit disparaît ! Ton professeur te met -2 sur ta note si tu rends ton devoir en retard. Le soleil commence à se lever, la date butoir est à 8h00. Tu n''as pas le temps de tout recoder. Peux-tu retrouver le commit perdu et sauver ton année ?',
        'G1THax3er_3wqC8D',
        215,
        'Collaboration',
        2,
    ...
    (
        2,
        'Hydre de Lerne',
        'L''Hydre de Lerne, une créature mythique, te barre aujourd''hui la route. Un corps, plusieurs têtes, et une apparence monstrueuse. Prouve ton courage en faisant face à ce défi. N''ai pas peur de son apparence, tu es capable de défaire ce monstre.',
    ...
    (
        4,
        'Le pilote fantôme',
        'Des activités illégales internationales ont été signalées, impliquant le transport de marchandises prohibées par voie aérienne. Les autorités soupçonnent qu'' un pilote professionnel serait complice de ces opérations, utilisant sa position pour traverser les frontières sans éveiller les soupçons. Nous avons quelque indice au sujet de ce pilote: ● Le pilote a travaillé pour au moins 3 compagnies différentes pour brouiller les pistes ● Certains de ses vols ont connu des "incidents" suspects ● Son parcours forme un schéma spécifique à travers plusieurs pays connus pour leurs activités criminelles En tant qu''analyste de données pour Interpol, votre mission est d'' identifier ce pilote et de retracer son itinéraire complet. Le flag a trouvé est la concaténation de tous les aéroports parcourue par le criminel dans l''ordre chronologique. Ex: JFK -> CDG -> MDE -> DXB donne le flag JFKCDGMDEDXB',
    ...
    (
        ...
        'Vous travaillez pour une agence matrimoniale révolutionnaire qui garantit des couples parfaitement compatibles ! Votre mission : créer un algorithme qui assure des mariages stables entre deux groupes de personnes. Chaque personne dispose d’une liste de préférences, classant les membres du groupe opposé par ordre de préférence. Votre objectif est d’associer chaque individu à un partenaire de manière stable, c''est-à-dire qu''aucun couple ne doit vouloir se séparer pour reformer un autre couple plus avantageux pour les deux parties. Voici la liste des inscrits à l’agence matrimoniale, avec leurs préférences classées du plus apprécié au moins apprécié : Alex : Iris, Fabienne, Léa, Sarah, Julie Ben : Léa, Julie, Fabienne, Sarah, Iris Charles : Sarah, Iris, Fabienne, Julie, Léa David : Julie, Léa, Sarah, Fabienne, Iris Éric : Fabienne, Sarah, Léa, Iris, Julie Iris : Ben, David, Charles, Alex, Éric Fabienne : David, Éric, Ben, Charles, Alex Léa : Alex, Ben, Charles, Éric, David Sarah : Charles, Ben, David, Alex, Éric Julie : Ben, Charles, Alex, Éric, David Saurez-vous former les couples parfaits ?',
        'ILSJF',
        425,
        'Algorithmie',
        4,
    ...
    (
        6,
        'SQLI Level 1',
        'Tu viens d''être embauché comme testeur de sécurité par une start-up technologique qui souhaite évaluer la sécurité de son nouveau portail de connexion développé en Node.js. Ta mission est de vérifier si le formulaire de connexion est vulnérable aux injections SQL et de prouver la faille en obtenant l''accès administrateur. Le flag se trouve dans l''interface administrateur, accessible uniquement après une connexion réussie en tant qu''administrateur. Bonne chance.',
